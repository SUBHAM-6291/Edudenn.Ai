...
const Footer = () => {
  return (
    ...
    >
      ...
      {/* Content Container */}
      <div className="relative flex flex-col flex-1 max-w-[1619px] mx-auto px-2 sm:px-4 md:px-6 lg:px-8 xl:px-10 py-3 sm:py-6 md:py-8 lg:py-10 xl:py-12">
        <div className="flex-1 rounded-lg p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 md:gap-8 lg:gap-10 text-left">
            ...
            <div className="space-y-2 sm:space-y-4 md:space-y-5">
              ...
              <div className="flex space-x-1 sm:space-x-2 md:space-x-3">
                {[
                  ...
                  <a key={idx} href={href} target="_blank" rel="noopener noreferrer" aria-label={`Follow EduDen on ${label}`}>
                    <img
                      src={src}
                      alt={label}
            ...
            <div className="space-y-2 sm:space-y-4 md:space-y-5">
              <h3 className="font-gucina text-[0.7rem] sm:text-sm md:text-base lg:text-lg font-semibold">Quick Links</h3>
            ...
            <div className="space-y-2 sm:space-y-4 md:space-y-5">
              <h3 className="font-gucina text-[0.7rem] sm:text-sm md:text-base lg:text-lg font-semibold">Learning Platform</h3>
            ...
            <div className="space-y-2 sm:space-y-4 md:space-y-5">
              <h3 className="font-gucina text-[0.7rem] sm:text-sm md:text-base lg:text-lg font-semibold">Get in Touch</h3>
              <ul className="space-y-1 sm:space-y-2">
                <li>
        ...
        <div className="mt-auto">
          <hr className="border-gray-600 mt-3 sm:mt-6 md:mt-8 lg:mt-10" />
          <div className="text-left sm:text-center text-[0.6rem] sm:text-xs md:text-sm lg:text-base pt-2 sm:pt-4 md:pt-6 lg:pt-8 pb-2 sm:pb-4">
