...
const Allcourse = () => {
  ...
  return (
    <div className="bg-black p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
      {/* Heading Icons Row */}
      ...
      {/* Filter Section */}
      <div className="w-full max-w-7xl mx-auto mb-8 sm:mb-10 md:mb-12">
                  ...
                  <div className="relative z-0 flex flex-col justify-start h-[calc(50%-4rem)] p-4 sm:p-5 md:p-6 text-black">
                    ...
                    <div className="flex justify-between items-center mb-4 sm:mb-6 gap-x-2 sm:gap-x-4">
                      ...
                      <div className="flex gap-1 pr-8 sm:pr-10 md:pr-12">
                        {[...Array(5)].map((_, i) => (
                          <svg key={i} className="w-4 sm:w-5 h-4 sm:h-5 text-yellow-400 fill-current" viewBox="0 0 24 24">
                ...
                <div className="absolute w-full h-full backface-hidden rotate-y-180 bg-yellow-400 p-4 sm:p-5 md:p-6 flex flex-col justify-between">
                  <div className="flex justify-between mb-4 sm:mb-6">
                    ...
                    <div className="flex gap-1">
                      {[...Array(5)].map((_, i) => (
                        <svg key={i} className="w-4 sm:w-5 h-4 sm:h-5 text-black fill-current" viewBox="0 0 24 24">
                          <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                        </svg>
                      ))}
                    </div>
