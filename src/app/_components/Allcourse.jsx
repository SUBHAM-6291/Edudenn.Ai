  ...
  return (
    <div className="bg-black p-4 sm:p-8">
      ...
      <div className="flex items-center gap-10 mb-8 justify-center">
        ...
        {/* Popular Courses text - just font family, no size change */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 place-items-center">
          {courses.map((course) => (
            <Link
              ...
              className="relative rounded-2xl w-full max-w-[24rem] h-[38.36rem] overflow-hidden cursor-pointer transition-transform duration-300 hover:scale-105 focus:scale-105 hover:shadow-lg focus:shadow-lg outline-none bg-white"
              tabIndex={0}
            ...
            >
              ...
              {/* Yellow Circle */}
              <div className="absolute right-2 top-1/2 -translate-y-1/2 bg-yellow-400 rounded-full w-20 h-20 flex items-center justify-center text-black font-bold text-lg z-10">
                ${course.price}
              </div>
              ...
              <div className="relative z-0 flex flex-col justify-start h-[calc(50%-4rem)] p-6 text-black">
                ...
                <div className="flex justify-between items-center mb-6 gap-x-4">
                  <button
                    className="bg-yellow-400 text-black font-medium font-gucina rounded-2xl text-sm px-4 py-2 hover:bg-yellow-500 transition-colors"
                  >
                    All Cyber Security
                  </button>
